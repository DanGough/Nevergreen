try {
    ...
    $Product = ($Response.data.contentJson.entries | ConvertFrom-Json).downloadData.'vc-win'
    ...
    New-NevergreenApp -Name 'Elgato Video Capture' -Version $Product.version -Uri $Product.downloadURL -Architecture 'x86' -Type 'MSI'
}
catch {
