try {
    ...
    $Product = ($Response.data.contentJson.entries | ConvertFrom-Json).downloadData.'4kcu-win'
    ...
    New-NevergreenApp -Name 'Elgato 4K Capture Utility' -Version $Product.version -Uri $Product.downloadURL -Architecture 'x64' -Type 'MSI'
}
catch {
