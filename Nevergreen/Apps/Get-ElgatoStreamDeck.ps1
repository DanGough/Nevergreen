try {
    ...
    $Product = ($Response.data.contentJson.entries | ConvertFrom-Json).downloadData.'sd-win'
    ...
    New-NevergreenApp -Name 'Elgato Stream Deck' -Version $Product.version -Uri $Product.downloadURL -Architecture 'x64' -Type 'MSI'
}
catch {
