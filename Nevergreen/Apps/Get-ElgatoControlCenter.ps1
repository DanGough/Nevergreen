try {
    ...
    $Product = ($Response.data.contentJson.entries | ConvertFrom-Json).downloadData.'cc-win'
    ...
    New-NevergreenApp -Name 'Elgato Control Center' -Version $Product.version -Uri $Product.downloadURL -Architecture 'x64' -Type 'MSI'
}
catch {
