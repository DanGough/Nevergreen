...
New-NevergreenApp -Version $Version64 -Uri $URL64 -Architecture 'x64' -Channel 'Latest'
New-NevergreenApp -Version $Version64LTR -Uri $URL64LTR -Architecture 'x64' -Channel 'LTR'