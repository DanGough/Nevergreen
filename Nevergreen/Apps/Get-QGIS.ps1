...
$URL64 = $Resp.Links | Where-Object href -Like '*.msi' | Select-Object -First 1 -ExpandProperty href
$Version = ($URL64 | Select-String -Pattern '((?:\d+\.)+(?:\d+))').Matches.Groups[1].Value

$URL64LTR = $Resp.Links | Where-Object href -Like '*.msi' | Select-Object -First 1 -Skip 1 -ExpandProperty href
