try {
    ...
    $Version = Get-Version -Uri 'https://s.mzstatic.com/version' -Pattern '<key>iTunesWindowsVersion</key>\s+<string>((?:\d+\.)+\d+)</string>' -ErrorAction Stop
    ...
    $URL64 = (Resolve-Uri -Uri 'https://www.apple.com/itunes/download/win64').Uri
    $URL32 = (Resolve-Uri -Uri 'https://www.apple.com/itunes/download/win32').Uri
